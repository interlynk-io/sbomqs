...
var profileBSI21Spec = catalog.ProfSpec{
	...
	Features: []catalog.ProfFeatSpec{
		...
		{Key: "comp_original_license", Name: "Declared/Original Licences", Required: false, Additional: true, Description: "Declared licence (acknowledgement=declared)", Evaluate: profiles.BSIV21CompOriginalLicences},
