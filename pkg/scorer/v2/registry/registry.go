...
var CompKeyToEvaluatingFunction = map[string]catalog.ComprFeatEval{
	...
	"sbom_completeness_declared": extractors.CompWithDeclaredCompleteness,
...
var CatCompletenessSpec = catalog.ComprCatSpec{
	...
	Features: []catalog.ComprFeatSpec{
		...
		{Key: "sbom_completeness_declared", Name: "Component With Declared Completeness", Weight: 0.15, Ignore: false, Evaluate: extractors.CompWithDeclaredCompleteness},
...
var profileFSCTSpec = catalog.ProfSpec{
	Key:         ProfileFSCT,
	Name:        "Framing Third Edition Compliance",
