...
func TestFsctDependencies(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			actual: fsctPackageDependencies(a, a.Components()[1]),
			expected: desired{
				score:    10.0,
				result:   "",
		...
		},
		{
			...
			actual: fsctPackageDependencies(b, b.Components()[1]),
			expected: desired{
				score:    12.0,
		...
		},
		{
			...
			actual: fsctPackageDependencies(c, c.Components()[1]),
			expected: desired{
				score:    10.0,
				result:   "",
				key:      COMP_RELATIONSHIP,
		...
		},
		{
			...
			actual: fsctPackageDependencies(d, d.Components()[1]),
			expected: desired{
				score:    12.0,
				result:   "go-crypto",
				key:      COMP_RELATIONSHIP,
		...
		},
		{
			...
			actual: fsctPackageDependencies(e, e.Components()[1]),
			expected: desired{
				score:    12.0,
