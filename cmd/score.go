...
func init() {
	...
	scoreCmd.Flags().StringSlice("profile", nil, "profiles to run ('ntia'|'cisa-2021'|'cisa2021', 'cisa-2026'|'cisa'|'cisa2026', 'fsct', 'bsi', 'bsi-v1.1'|'bsiv11', 'bsi-v2.0'|'bsiv20', 'bsi-v2.1'|'bsiv21', 'oct-v1.1'|'octv11'|'oct', 'interlynk')")
